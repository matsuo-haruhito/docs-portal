...
module Admin::ProjectConsentSettingsHelper
  def project_consent_setting_table_columns
    [
      table_preferences_column(:project, label: "案件", default_width: 220, pinned: true),
      table_preferences_column(:consent_term, label: "同意文面", default_width: 260, overflow: :ellipsis),
      table_preferences_column(:version_label, label: "版", default_width: 120),
