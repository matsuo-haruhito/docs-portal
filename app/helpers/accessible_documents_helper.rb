...
module AccessibleDocumentsHelper
  ...
  def accessible_document_table_columns(keyword_search: false)
    [
      ...
      table_preferences_column(:importance_level, label: "重要度", default_visible: false, default_width: 80),
      table_preferences_column(:visibility_policy, label: "公開範囲", default_visible: false, default_width: 85),
