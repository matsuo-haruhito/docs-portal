class Api::Internal::ZipImportsController < Api::BaseController
  ...
  def ensure_zip_dry_run!
    raise ApplicationError::BadRequest, "import_dry_run_id is required for ZIP import execution" unless confirmed_dry_run
