...
MAINTENANCE_ROUTE_INVENTORY_DOC_SIGNALS = [
  ...
  "| 文書一括編集 | `admin/bulk_edit_dry_runs#create` / `#update` / `#handoff` | current。",
  "| 文書版 rollback / 文書状態変更 | `document_version_rollbacks#create`, `admin/documents#archive` / `#restore` | 要判断。",
