...
first batch は `rails_fields_kit` の static visual PR 群を優先します。reviewer は各 PR で head SHA、workflow run、mergeable、compare freshness を確認してから evidence comment を残してください。
