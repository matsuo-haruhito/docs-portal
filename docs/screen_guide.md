...
![管理ダッシュボード ダッシュボード](screenshots/admin_dashboard.png)
...
- アクセスログの検索・フィルタ（ユーザー・操作種別・対象・日時）

![アクセスログ 一覧画面](screenshots/admin_access_logs_index.png)
...
![ダッシュボード ダッシュボード](screenshots/dashboard.png)
...
![ショートカット お気に入り](screenshots/document_bookmarks_favorite.png)
...
![ショートカット 後で読む](screenshots/document_bookmarks_read_later.png)
...
![ショートカット 最近見た文書](screenshots/document_bookmarks_recent.png)
...
![トップページ ダッシュボード](screenshots/root.png)
