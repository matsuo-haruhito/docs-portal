...
RSpec.describe "Project sites", type: :request do
  ...
  it "renders embedded project site html for the iframe body" do
    ...
    expect(response.body).to include('data-docs-portal-embedded-viewer="true"'.delete("\\"))
    expect(response.body).to include('data-docs-portal-embedded-height-sync="true"'.delete("\\"))
