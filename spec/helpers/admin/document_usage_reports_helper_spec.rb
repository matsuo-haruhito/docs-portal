  ...
  describe "usage row cues" do
    it "labels unused, read-confirmation-only, and used rows separately" do
      ...
      aggregate_failures do
        ...
        expect(helper.document_usage_report_usage_hint(unused)).to eq("期間内の閲覧・DL・既読確認なし")
        ...
        expect(helper.document_usage_report_usage_hint(read_confirmation_only)).to eq("既読確認の内訳を確認")
