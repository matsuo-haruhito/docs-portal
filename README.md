...
- 関連 gem の使用箇所、upstream docs / issue の入口、`admin/document_sets` を代表例にした host app 側の組み合わせ方は [docs/関連gem連携調査runbook.md](./docs/関連gem連携調査runbook.md) を参照してください。
...
- `文書ショートカット` 画面で `お気に入り` `後で読む` `最近見た文書` の見分け方、`解除` 後の戻り方、`案件一覧へ戻る` の使いどころを確認するときは [docs/文書ショートカット運用runbook.md](./docs/%E6%96%87%E6%9B%B8%E3%82%B7%E3%83%A7%E3%83%BC%E3%83%88%E3%82%AB%E3%83%83%E3%83%88%E9%81%8B%E7%94%A8runbook.md) を参照してください。
...
- 手動アップロード後に `差異を確認してOK/NGを選択してください。` と案内されたときの review 手順、既存文書の版更新候補と新規文書候補の見分け方、反映後の取り消し導線は [docs/手動アップロード差異確認runbook.md](./docs/%E6%89%8B%E5%8B%95%E3%82%A2%E3%83%83%E3%83%97%E3%83%AD%E3%83%BC%E3%83%89%E5%B7%AE%E7%95%B0%E7%A2%BA%E8%AA%8Drunbook.md) を参照してください。
- `文書マスタ` 画面で検索・状態確認、保管期限 / 廃棄候補、公開側文書への戻り方を見直すときは [docs/文書マスタ運用runbook.md](./docs/%E6%96%87%E6%9B%B8%E3%83%9E%E3%82%B9%E3%82%BF%E9%81%8B%E7%94%A8runbook.md) を参照してください。
...
- `文書セット` 一覧の `種別` / `公開範囲` filter、列の見方、`固定版` と `最新版を使う` の使い分け、文書 0 件案件の empty state の戻り先は [docs/文書セット運用runbook.md](./docs/%E6%96%87%E6%9B%B8%E3%82%BB%E3%83%83%E3%83%88%E9%81%8B%E7%94%A8runbook.md) を参照してください。
- `案件所属` と `文書権限` を対で見直し、0 件からの初回登録、文書ごとの件数確認、個別付与の編集導線を確認するときは [docs/案件所属・文書権限運用runbook.md](./docs/%E6%A1%88%E4%BB%B6%E6%89%80%E5%B1%9E%E3%83%BB%E6%96%87%E6%9B%B8%E6%A8%A9%E9%99%90%E9%81%8B%E7%94%A8runbook.md) を参照してください。
- 監査ログの絞り込み項目、表示設定、最新 200 件の中でどの列を残して読むかは [docs/監査ログ運用runbook.md](./docs/%E7%9B%A3%E6%9F%BB%E3%83%AD%E3%82%B0%E9%81%8B%E7%94%A8runbook.md) を参照してください。
...
- 外部フォルダ同期の provider-aware な入口、Google Drive の current support、SharePoint / OneDrive の準備導線は [docs/外部フォルダ同期dry-run・apply運用runbook.md](./docs/%E5%A4%96%E9%83%A8%E3%83%95%E3%82%A9%E3%83%AB%E3%83%80%E5%90%8C%E6%9C%9Fdry-run%E3%83%BBapply%E9%81%8B%E7%94%A8runbook.md) を参照してください。
