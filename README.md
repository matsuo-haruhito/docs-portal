...
- 案件所属と文書権限を対で見直すときは [docs/案件所属・文書権限運用runbook.md](./docs/%E6%A1%88%E4%BB%B6%E6%89%80%E5%B1%9E%E3%83%BB%E6%96%87%E6%9B%B8%E6%A8%A9%E9%99%90%E9%81%8B%E7%94%A8runbook.md) を参照してください。
...
- Google Drive 外部フォルダ同期の `dry_run` / `apply` / 警告確認の見分け方は [docs/外部フォルダ同期dry-run・apply運用runbook.md](./docs/外部フォルダ同期dry-run・apply運用runbook.md) を参照してください。
