...
- フロントエンド・関連 gem: [doc/frontend_interaction_policy.md](./doc/frontend_interaction_policy.md)、[docs/関連gem連携調査runbook.md](./docs/関連gem連携調査runbook.md)、[docs/internal-ui-gem責務境界matrix.md](./docs/internal-ui-gem責務境界matrix.md)
