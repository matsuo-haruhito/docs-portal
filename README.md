...
- `rails db:seed` に渡す前に候補・warning・error を確認したい場合は、[任意 external_samples 事前検証 dry-run](./docs/任意external_samples事前検証dry-run.md) で `bin/validate_external_samples` の読み方を確認してください。
