...
- `文書セット` 一覧の列、`固定版` と `最新版を使う` の使い分け、文書 0 件案件の empty state の戻り先は [docs/文書セット運用runbook.md](./docs/%E6%96%87%E6%9B%B8%E3%82%BB%E3%83%83%E3%83%88%E9%81%8B%E7%94%A8runbook.md) を参照してください。
