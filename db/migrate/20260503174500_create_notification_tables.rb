class CreateNotificationTables < ActiveRecord::Migration[8.1]
  def change
    ...
    add_index :notification_receipts, [:notification_event_id, :user_id], unique: true, name: "idx_notification_receipts_event_user"
    add_index :notification_receipts, [:user_id, :read_at]
  end
end
